...
public class PrimaryCuisineSecondaryCostBracketLowRatingStrategy implements RestaurantSortingStrategy{
    private CuisineAndCostBracketCategory category;

    public PrimaryCuisineSecondaryCostBracketLowRatingStrategy(CuisineAndCostBracketCategory category ) {
