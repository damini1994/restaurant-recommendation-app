...
public class SecondaryCuisinePrimaryCostBracketLowRatingStrategy implements RestaurantSortingStrategy{

    private CuisineAndCostBracketCategory category;

    public SecondaryCuisinePrimaryCostBracketLowRatingStrategy(CuisineAndCostBracketCategory category ) {
