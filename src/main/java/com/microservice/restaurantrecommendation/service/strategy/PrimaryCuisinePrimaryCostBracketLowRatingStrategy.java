...
public class PrimaryCuisinePrimaryCostBracketLowRatingStrategy implements RestaurantSortingStrategy{
    private CuisineAndCostBracketCategory category;

    public PrimaryCuisinePrimaryCostBracketLowRatingStrategy(CuisineAndCostBracketCategory category) {
